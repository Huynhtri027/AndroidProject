...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtValueTemp, txtValuePH, txtValueOxy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtValueTemp = (TextView) findViewById(R.id.id_temperaturevlue);
        txtValuePH   = (TextView) findViewById(R.id.id_oxyvalue);
        txtValueOxy  = (TextView) findViewById(R.id.id_oxyvalue);

        float minX = 50.0f;
        float maxX = 100.0f;

        Random rand = new Random();
        float rd = (maxX - minX) * rand.nextFloat();
        float temp = round(rd);
        System.out.print(temp);
        txtValueTemp.setText(String.valueOf(temp));
    ...
    public void LineChar(){
        ...
        entries.add(new Entry(4f, 0)); // color
